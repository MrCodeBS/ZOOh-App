...
function createTicketCanvas(ticketData) {
    ...
    ctx.strokeRect(canvas.width - 200, 40, 160, 160);
...
function createDownloadableTicket(ticketData) {
    ...
    if (qrImage) {
        const ctx = canvas.getContext('2d');
        ctx.drawImage(qrImage, canvas.width - 180, 60, 120, 120);
    }
    ...
    modalContent.insertBefore(downloadBtn, document.querySelector('.close-modal'));
